...
```bash
# Core
npm install commander jira.js execa

# Interactive + UX
npm install @clack/prompts chalk conf
...
**For worktree operations (add/list/remove):**
...
**For interactive ticket selection:**
...
**For config commands (setup/init):**
...
---
*Stack research for: TypeScript CLI tool (mafcli) — git worktrees + JIRA Cloud*
*Researched: 2026-04-02*
